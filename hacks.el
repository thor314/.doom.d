...
(defun tk/aoeu () (interactive)
       (shell-command "setxkbmap us dvorak -option ctrl:nocaps"))
(defun tk/asdf () (interactive)
       (shell-command "setxkbmap us -option ctrl:nocaps"))
(defun tk/caps_arghh () (interactive)
       (shell-command "setxkbmap us dvorak -option ctrl:swapcaps"))
(tk/aoeu)
